...
{{< q-figure src="Image-1-CGW.bmp" alt="Selection from changes tab of the  MAIN Spreadsheet" caption="Screen shot of the changes tab in the MAIN spreadsheet." >}}
...
{{< q-figure src="Graph-1-CGW.bmp" alt="" caption="Percentage of Acquisitions by the Tate of art by female artists for 25 year periods" >}}
